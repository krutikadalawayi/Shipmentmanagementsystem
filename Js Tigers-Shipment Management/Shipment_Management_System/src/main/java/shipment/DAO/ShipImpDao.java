...
public class ShipImpDao {
	public class TodoDaoImpl implements ShipDao {
	    ...
	    public void insertTodo(Todo todo) throws SQLException {
	        ...
	        try (Connection connection = JDBC_Utils.getConnection(); PreparedStatement preparedStatement = connection.prepareStatement(INSERT_TODOS_SQL)) {
	            preparedStatement.setString(1, todo.getTitle());
	            preparedStatement.setString(2, todo.getUsername());
	            preparedStatement.setString(3, todo.getDescription());
	            preparedStatement.setDate(4, JDBC_Utils.getSQLDate(todo.getTargetDate()));
	    ...
	    public Todo selectTodo(long todoId) {
	        ...
	        try (Connection connection = JDBC_Utils.getConnection();
	            ...
	            JDBC_Utils.printSQLException(exception);
	        }
	        return todo;
	    }@Override
	    ...
	    public boolean updateTodo(Todo todo) throws SQLException {
	        boolean rowUpdated;
	        try (Connection connection = JDBC_Utils.getConnection(); PreparedStatement statement = connection.prepareStatement(UPDATE_TODO);) {
	            statement.setString(1, todo.getTitle());
	            statement.setString(2, todo.getUsername());
	            statement.setString(3, todo.getDescription());
	            statement.setDate(4, JDBC_Utils.getSQLDate(todo.getTargetDate()));
